...
<link rel="stylesheet" href="/admin-v18.css?v=19.1.0">
<script src="https://cdn.jsdelivr.net/npm/@supabase/supabase-js@2"></script>
<script src="/admin-auth-v18.js?v=19.1.0" defer></script>
</head>
<body>
...
<section id="tab-pages" class="tab hidden">
  ...
  <div class="dashboardGrid">
    <form id="pageForm" class="panel formGrid">
      ...
      <label class="wide">Imagen principal URL<input id="pageHeroImage" placeholder="https://..."></label>
...
<section id="tab-staff" class="tab hidden">
   ...
   <section id="tab-settings" class="tab hidden"><form id="settingsForm" class="panel formGrid"><label>Nombre<input id="sName"></label><label>WhatsApp<input id="sWhatsapp" placeholder="593999999999"></label><label class="wide">Descripción<textarea id="sDescription"></textarea></label><label>Dirección<input id="sAddress"></label><label>Horario<input id="sSchedule"></label><label>Costo delivery<input id="sDelivery" type="number" min="0" step="0.01"></label><label>Pedido mínimo<input id="sMinimum" type="number" min="0" step="0.01"></label><label class="check"><input id="sAccepting" type="checkbox"> Recibir pedidos</label><div class="wide"><button class="primary">Guardar cambios</button></div></form></section>
 </div>
</section>

<div id="loginModal" class="modal adminLoginVisible"><div class="modalCard loginCard"><button class="close" data-close="loginModal">×</button><img src="media/logo.png" alt="Mordisco"><span class="eyebrow">MORDISCO OS</span><h2>Acceso de administrador</h2><p>Ingresa con tu correo y contraseña de administración.</p><form id="loginForm" autocomplete="off"><input id="loginEmail" name="mordisco_admin_email" type="email" placeholder="Correo" autocomplete="username" required><input id="loginPassword" name="mordisco_admin_password" type="password" placeholder="Contraseña" autocomplete="current-password" required><button class="primary">Ingresar</button></form><small id="loginMessage"></small></div></div>
...
<script src="/admin-v18.js?v=19.1.0"></script>



<div id="v18VersionMarker">Mordisco OS V19.1</div>
</body></html>